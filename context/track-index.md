...
Includes: 6) Canvas renderer + camera pan/zoom (touch) 7) Tap inspector stub (location or entity) 8) Metrics panel skeleton 9) Save/load settings (seed, speed, toggles) 10) Worker-ready architecture stub
...
Includes: 11) World grid data structure 12) Terrain generator v1 (blobs) 13) Terrain effects table (friction, perception, plant cap) 14) Terrain rendering 15) Water + shore corridors
...
Includes: 16) Grass regrowth to cap 17) Diminishing regrowth near cap 18) Overgrazing stress 19) Stress recovery 20) Bush entities + berry pool
...
Includes: 21) Bush recovery 22) Berry regeneration tied to bush health 23) Plant rendering 24) Plant metrics 25) “Known seed” hotspot validation
...
Includes: 26) Creature model + meters 27) Life stages scaling 28) Basal metabolism drains 29) Movement with terrain friction 30) Thirst/hunger priority
...
Includes: 31) Drinking behavior 32) Grass eating (Circles only; other species skip) 33) Stamina + sprinting 34) Death conditions 35) Population counters
...
Includes: 36) Canonical diet ranking + fallback rules (Squares/Triangles/Circles/Octagons) 37) Food properties (nutrition/handling/risk) aligned to canon resources 38) Digestive efficiency biases (canon anti-omnivore rules) 39) Perception v1 (sight + terrain) 40) Alertness + reaction delay 41) Memory records (food/water/danger/mate spots) 42) Scout vs route-runner emergence
...
Includes: 43) Target scoring (Triangles hunt Circles/Octagons; Octagons hunt Squares) 44) Chase loop (stamina + losing target)
...
Includes: 45) Reproduction loop 46) Genome + inheritance 47) Mutation rules + pleiotropy tradeoffs
...
Includes: 48) Universal color integration across all canonical species 49) Color perception + mate preference inspector upgrades
...
Includes: 50) Multi-hit combat + cooldowns 51) Hit probability + evasion 52) Wounded + healing
...
Includes: 53) Stability controls 54) Long-run verification suite
